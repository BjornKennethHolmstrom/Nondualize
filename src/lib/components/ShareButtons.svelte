...
<script lang="ts">
  ...
  $: defaultTitle = currentLanguage === 'en' 
    ? 'Nondualize - Exploring Non-Dual Awareness'
    : 'Nondualize - Utforska Icke-dual Medvetenhet';
    
  $: defaultDescription = currentLanguage === 'en'
    ? 'Free, open resource for exploring non-dual awareness through understanding and direct recognition.'
    : 'Gratis, öppen resurs för att utforska icke-dual medvetenhet genom förståelse och direkt igenkänning.';
...
<div class="flex flex-col items-center space-y-4 py-8 border-t border-slate-200 dark:border-slate-700">
  ...
  <div class="flex space-x-4">
    ...
    >
      ...
      {#if copied}
        <span class="absolute -top-8 left-1/2 transform -translate-x-1/2 bg-slate-700 dark:bg-slate-300 text-white dark:text-slate-900 text-sm py-1 px-2 rounded whitespace-nowrap">
